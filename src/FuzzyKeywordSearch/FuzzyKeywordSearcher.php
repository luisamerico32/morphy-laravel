...
class FuzzyKeywordSearcher
{
    ...
    public function searchKeywordInSourceString(string $sourceString, WordCollection $sourceWords, WordCollection $searchWords): string
    {
        ...
        return $this->presenceGroupsWordsInStringAnalyzer->analyze($foundGroupsWords, $sourceString);
    }
}
